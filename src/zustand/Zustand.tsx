...
// zustand 패키지 :
// - react 에서 사용할 수 있는 상태 관리 패키지 중 하나
// - 상태 관리 패키지 중 과거에는 Redux 패키지가 가장 많이 사용됐지만 현재는 zustand로 이용
...
// - typescript 에서는 zustand의 store 타입을 create 함수의 제너릭으로 제너릭으로 전달해줘야함
...
export default function Zustand() {
  ...
  // const { 상태, ..., 상태 변경 함수, ... } = useStore 훅함수
  ...
  //   setAddress(value);
  return (
    <div style={{ padding: '40px', height: '400px', background: 'grey' }}>
      {/* <h1>{address}</h1>
